...
function SideBarMain(prop) {
  return (
    <div
      ...
      className={prop.type == 'Drawer' ? 'pb-16 overflow-y-auto bg-[#19171D] block flex-none max-h-[100vh] w-64' : 'pb-16 overflow-y-auto bg-[#19171D] hidden md:block md:flex-none max-h-[100vh] md:w-64 '}
